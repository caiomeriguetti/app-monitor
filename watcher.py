...
alerts = {
	...
	"picpay-backend.core.ConsumerShell.processConsumerRecentInteractions":[
		{'id': 'processConsumerRecentInteractions-dead', 'name': 'processConsumerRecentInteractions morreu', 'eq': 0, 'for': 2},
	],
