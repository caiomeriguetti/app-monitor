...
sudo docker exec -d -i appmonitor bash -c "cd /var && git clone https://github.com/caiomeriguetti/app-monitor.git && /bin/bash /var/app-monitor/docker-container/update-app.sh"